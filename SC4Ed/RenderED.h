...
public:
	...
	void Init(SC4Core*); // Initialize Rendering core
	...
	void RenderObject(HDC, int x, int y, unsigned gfxNum, unsigned palNum = 0, int assemblyNum = -1, int slotOffset = 0);
